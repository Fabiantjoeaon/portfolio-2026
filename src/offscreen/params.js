...
export const params = {
  ...
  IceScene: {
    ...
    Cave: {
      caveBodyFill: { value: 0.5, min: 0, max: 0.5, step: 0.01, name: "Ice Body" },
      caveRoughnessScale: { value: 1, min: 0, max: 1, step: 0.01, name: "Roughness Detail" },
      caveRoughnessBias: { value: 0.04, min: 0.04, max: 1, step: 0.01, name: "Surface Roughness" },
      ...
      caveUvScale: { value: 0.6, min: 0.1, max: 8, step: 0.05, name: "UV Scale" },
      caveParallaxScale: {
        value: 1.5,
        min: 0,
        max: 1.5,
