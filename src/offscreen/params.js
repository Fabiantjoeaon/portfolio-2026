...
export const params = {
  ...
  IceScene: {
    ...
    Scene: {
      sceneZ: { value: -60, min: -200, max: 80, step: 1, name: "Cave Z" },
    ...
    Cave: {
      caveFrontZ: { value: 92, min: -80, max: 160, step: 1, name: "Mouth Z" },
      caveLength: { value: 201, min: 40, max: 400, step: 1, name: "Length" },
      caveWidth: { value: 35, min: 8, max: 80, step: 0.5, name: "Width" },
      caveHeight: { value: 45, min: 8, max: 90, step: 0.5, name: "Height" },
      caveTaper: { value: 0.56, min: 0, max: 1, step: 0.01, name: "Taper" },
      caveBend: { value: 5, min: 0, max: 20, step: 0.1, name: "Bend" },
      caveUvScale: { value: 1, min: 0.1, max: 8, step: 0.05, name: "UV Scale" },
      caveParallaxScale: {
        value: 0.38,
        min: 0,
        max: 1.5,
    ...
    Ground: {
      uvScale: { value: 24, min: 1, max: 80, step: 0.5, name: "UV Scale" },
      parallaxScale: {
        value: 0.38,
        min: 0,
        max: 1.5,
      ...
      colorIntensity: { value: 1.1, min: 0, max: 3, step: 0.02, name: "Color" },
      reflectionStrength: {
        value: 0.65,
        min: 0,
        max: 2,
      ...
      normalScale: { value: 0.85, min: 0, max: 3, step: 0.02, name: "Normals" },
    },
    Material: {
      tint: { value: 0x28677f, type: "color", name: "Tint" },
      roughnessScale: {
        value: 0.32,
        min: 0,
        max: 1,
    ...
    Fog: {
      fogColor: { value: 0x0b1e2a, type: "color", name: "Color" },
      fogColor2: { value: 0x284a5c, type: "color", name: "Color 2" },
      fogDensity: { value: 0.016, min: 0, max: 0.12, step: 0.001, name: "Density" },
      fogAlpha: { value: 0.8, min: 0, max: 1, step: 0.01, name: "Alpha" },
      fogHeightFalloff: {
        value: 0.19,
        min: 0,
        max: 1,
      ...
      fogSpeed: { value: 0.45, min: 0, max: 2, step: 0.01, name: "Speed" },
      fogFrequency: {
        value: 0.055,
        min: 0.005,
        max: 0.3,
