...
export const params = {
  ...
  MeadowScene: {
    ...
    Rain: {
      ...
      rainSpeed: { value: 30, min: 8, max: 60, step: 0.5, name: 'Fall Speed' },
      ...
      rainOpacity: { value: 0.22, min: 0, max: 1, step: 0.01, name: 'Opacity' },
      rainWind: { value: 0.2, min: -0.4, max: 0.4, step: 0.01, name: 'Wind Slant' },
      rainLightStrength: { value: 1.11, min: 0, max: 3, step: 0.01, name: 'Screen Light' },
