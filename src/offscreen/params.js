...
export const params = {
  ...
  IceScene: {
    ...
    Cave: {
      ...
      caveHeight: { value: 37, min: 8, max: 90, step: 0.5, name: "Height" },
      caveTaper: { value: 0, min: 0, max: 1, step: 0.01, name: "Taper" },
      caveBend: { value: 3.3, min: 0, max: 20, step: 0.1, name: "Bend" },
    ...
    Fog: {
      fogBaseY: { value: -14, min: -20, max: 20, step: 0.5, name: "Base Height" },
      fogBillowHeight: { value: 5.5, min: 0, max: 30, step: 0.5, name: "Billow Height" },
      fogLightStrength: { value: 1.4, min: 0, max: 6, step: 0.05, name: "Screen Scattering" },
      fogAmbientStrength: { value: 0.105, min: 0, max: 0.2, step: 0.001, name: "Ambient Scattering" },
      fogColor: { value: 0xffffff, type: "color", name: "Color" },
      fogColor2: { value: 0xa2bdcc, type: "color", name: "Color 2" },
      fogDensity: { value: 0.031, min: 0, max: 0.12, step: 0.001, name: "Density" },
      ...
      fogSpeed: { value: 1.95, min: 0, max: 2, step: 0.01, name: "Speed" },
      fogFrequency: {
        value: 0.013,
        min: 0.005,
        max: 0.3,
