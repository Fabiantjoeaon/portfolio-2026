...
export const params = {
  ...
  AboutScene: {
    Portrait: {
      ...
      Dots: {
        portraitPointSize: { value: 1.7, min: 0.5, max: 8, step: 0.1, name: "Point Size (px)" },
        portraitDensity: { value: 1, min: 0, max: 1, step: 0.01, name: "Density" },
        portraitResponsiveDensity: { value: true, type: "boolean", name: "Adapt Density to Viewport" },
        portraitOpacity: { value: 0.68, min: 0, max: 1, step: 0.01, name: "Opacity" },
        portraitSoftness: { value: 0.45, min: 0.01, max: 1, step: 0.01, name: "Dot Softness" },
        portraitDither: { value: 0.65, min: 0, max: 1, step: 0.01, name: "Dither Amount" },
        portraitDitherScale: { value: 1, min: 0.5, max: 6, step: 0.5, name: "Dither Pixel Scale" },
        portraitNeckFade: { value: 0.23, min: 0, max: 1, step: 0.01, name: "Neck Fade" },
        portraitEdgeFade: { value: 0.16, min: 0, max: 1, step: 0.01, name: "Side Fade" },
      },
      Lighting: {
        ...
        portraitGamma: { value: 0.65, min: 0.1, max: 3, step: 0.01, name: "Luminance Gamma" },
        portraitAmbient: { value: 0.65, min: 0, max: 2, step: 0.01, name: "Ambient" },
        portraitLightStrength: { value: 0.65, min: 0, max: 3, step: 0.01, name: "Light Strength" },
        portraitLightDirection: { value: [-0.6, 0.8, 1], type: "vector", min: -2, max: 2, step: 0.05, name: "Light Direction" },
        portraitRim: { value: 0.3, min: 0, max: 2, step: 0.01, name: "Rim Light" },
      },
      Motion: {
        ...
        portraitMouseTilt: { value: 4, min: 0, max: 25, step: 0.5, name: "Mouse Tilt (deg)" },
      },
    },
    Camera: {
      fov: { value: 34 },
