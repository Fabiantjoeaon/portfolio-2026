...
export const params = {
  Transition: {
    ...
    Wipe: {
      ...
      Texture: {
        textureAmount: { value: 0, min: 0, max: 1, step: 0.01, name: "Texture Blend" },
        textureScale: { value: 0.1, min: 0.1, max: 2, step: 0.01, name: "Scale" },
      ...
      Digital: {
        digitalAmount: { value: 1, min: 0, max: 1, step: 0.01, name: "Digital Amount" },
        digitalCellSize: { value: 0.5, min: 0.5, max: 8, step: 0.1, name: "World Cell Size" },
        digitalInk: { value: 1, min: 0, max: 1, step: 0.01, name: "Interface Detail" },
        digitalPlaneAngle: { value: 15, min: -180, max: 180, step: 0.1, name: "World Plane Angle" },
        digitalDeformation: { value: 0.88, min: 0, max: 4, step: 0.01, name: "Square Deformation" },
        digitalSquareSize: { value: 0.48, min: 0.15, max: 0.48, step: 0.01, name: "Square Size" },
        digitalBandWidth: { value: 0.2, min: 0.006, max: 0.2, step: 0.001, name: "Detail Band" },
        digitalMarkerDensity: { value: 0.43, min: 0, max: 1, step: 0.01, name: "Marker Density" },
        digitalScanCycles: { value: 24.5, min: 0, max: 40, step: 0.5, name: "Scan Cycles" },
      },
    },
  },
  ...
  CubeScene: {
    ...
    Particles: {
      glyphEnabled: { value: true, type: "boolean", name: "Enabled" },
      glyphCount: { value: 199, min: 0, max: 1000, step: 1, name: "Count" },
      glyphLifetime: { value: 14, min: 1, max: 40, step: 0.5, name: "Lifetime (s)" },
      glyphLifetimeVariation: { value: 0.65, min: 0, max: 1, step: 0.01, name: "Lifetime Variation" },
      glyphDelay: { value: 1, min: 0, max: 10, step: 0.1, name: "Respawn Delay (s)" },
      glyphFadeIn: { value: 1.5, min: 0, max: 10, step: 0.1, name: "Fade In (s)" },
      ...
      glyphBounds: { value: [85, 20, 78], type: "vector", min: 0, max: 150, step: 1, name: "Emitter Size" },
      glyphVelocity: { value: [0.07, 0.6, 0], type: "vector", min: -3, max: 3, step: 0.01, name: "Velocity" },
      glyphDrift: { value: 0, min: 0, max: 5, step: 0.05, name: "Float Amount" },
      glyphDriftSpeed: { value: 0.4, min: 0, max: 3, step: 0.05, name: "Float Speed" },
      glyphRotationSpeed: { value: 0.22, min: 0, max: 1, step: 0.01, name: "Rotation Speed" },
      glyphRotationAmount: { value: 0, min: 0, max: 180, step: 1, name: "Rotation Amount (deg)" },
      glyphInterval: { value: 0.75, min: 0.1, max: 4, step: 0.05, name: "Symbol Interval (s)" },
      glyphIntervalVariation: { value: 1, min: 0, max: 1, step: 0.01, name: "Interval Variation" },
      glyphGlow: { value: 1.95, min: 0, max: 4, step: 0.01, name: "Glow Strength" },
    ...
    Highlight: {
      highlightLift: { value: 0, min: 0, max: 6, step: 0.05, name: "Lift" },
      highlightGlow: { value: 0.4, min: 0, max: 10, step: 0.05, name: "Glow" },
      highlightGap: { value: 3.15, min: 0, max: 4, step: 0.05, name: "Gap Light" },
      highlightDecay: { value: 0.5, min: 0.002, max: 0.5, step: 0.001, name: "Decay / Frame" },
    },
    FlowMap: {
      ...
      flowRadius: { value: 0.065, min: 0.01, max: 0.3, step: 0.005, name: "Brush Radius" },
      flowFade: { value: 3.25, min: 0.05, max: 5, step: 0.05, name: "Fade Speed" },
      flowDiffusion: { value: 0.98, min: 0, max: 1, step: 0.01, name: "Diffusion" },
      flowAdvection: { value: 2.95, min: 0, max: 4, step: 0.05, name: "Advection" },
      flowVelocityScale: { value: 0.35, min: 0, max: 2, step: 0.01, name: "Velocity Scale" },
      flowLift: { value: 1.6, min: 0, max: 6, step: 0.05, name: "Lift" },
      flowGlow: { value: 3.15, min: 0, max: 4, step: 0.05, name: "Gap Glow" },
      flowHighlight: { value: 0.87, min: 0, max: 1, step: 0.01, name: "Feeds Highlight" },
    },
  },
  ...
  MeadowScene: {
    ...
    Rain: {
      ...
      rippleStrength: { value: 0, min: 0, max: 1, step: 0.01, name: 'Impact Strength' },
    ...
    Roses: {
      ...
      roseRippleStrength: { value: 0, min: 0, max: 1.5, step: 0.01, name: 'Ripple Strength' },
    ...
    Water: {
      ...
      waterRoughness: { value: 0.34, min: 0.04, max: 0.9, step: 0.01, name: "Roughness" },
      waveScale: { value: 0.019, min: 0.005, max: 0.2, step: 0.001, name: "Wave Scale" },
      waveStrength: { value: 0.17, min: 0, max: 1, step: 0.01, name: "Wave Strength" },
      waveSpeed: { value: 0.037, min: 0, max: 0.05, step: 0.001, name: "Wave Speed" },
    },
    Shoreline: {
    ...
    Reflections: {
      reflectionStrength: { value: 1.68, min: 0, max: 2, step: 0.01, name: "Strength" },
      reflectionDistortion: { value: 0.09, min: 0, max: 0.2, step: 0.001, name: "Distortion" },
  ...
  IceScene: {
    ...
    Cave: {
      ...
      caveUvRepeatX: { value: 21, min: 1, max: 30, step: 1, name: "UV Across" },
      caveUvRepeatY: { value: 22, min: 1, max: 40, step: 1, name: "UV Along" },
      ...
      caveTaper: { value: 0.36, min: 0, max: 1, step: 0.01, name: "Taper" },
    ...
    Trail: {
      ...
      trailResolution: {
        value: "128",
        options: { "Low (128)": 128, "Balanced (256)": 256, "High (512)": 512 },
        name: "Resolution",
      },
      trailUpdateInterval: {
        value: 2,
      ...
      trailColor: { value: 0xf5f5f5, type: "color", name: "Frost Color" },
      trailRoughness: {
        value: 1,
        min: 0.04,
        max: 1,
    ...
    Ripple: {
      rippleSpeed: { value: 60, min: 1, max: 60, step: 0.5, name: "Speed (u/s)" },
      rippleWidth: { value: 10, min: 0.2, max: 10, step: 0.1, name: "Ring Width" },
      rippleFrequency: { value: 6, min: 0.1, max: 6, step: 0.05, name: "Wave Frequency" },
      rippleDecay: { value: 0.4, min: 0.05, max: 4, step: 0.05, name: "Decay" },
    ...
    Lights: {
      backlightColor: { value: 0x4db2ff, type: "color", name: "Back Color" },
      backlightIntensity: {
        value: 875,
        min: 0,
        max: 2000,
      ...
      rimColor: { value: 0x4d9eff, type: "color", name: "Rim Color" },
      rimIntensity: {
        value: 390,
        min: 0,
        max: 800,
