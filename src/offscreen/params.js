...
export const params = {
  ...
  AboutScene: {
    Portrait: {
      ...
      Layout: {
        portraitX: { value: -0.25, min: -0.5, max: 0.5, step: 0.005, name: "Horizontal Position" },
        portraitY: { value: 0, min: -0.5, max: 0.5, step: 0.005, name: "Vertical Position" },
        portraitScale: { value: 1, min: 0.1, max: 2.5, step: 0.01, name: "Scale" },
        portraitDepth: { value: 0.45, min: 0, max: 2, step: 0.01, name: "Depth" },
        portraitRotationX: { value: 0, min: -180, max: 180, step: 1, name: "Rotation X" },
        portraitRotationY: { value: -6, min: -180, max: 180, step: 1, name: "Rotation Y" },
      ...
      Dots: {
        ...
        portraitOpacity: { value: 0.24, min: 0, max: 1, step: 0.01, name: "Opacity" },
      ...
      Focus: {
        portraitFocus: { value: 0.95, min: 0, max: 1, step: 0.01, name: "Focus Depth" },
        portraitFocusWidth: { value: 0.28, min: 0.05, max: 1, step: 0.01, name: "Focus Range" },
        portraitDepthBlur: { value: 0.65, min: 0, max: 1, step: 0.01, name: "Depth Softness" },
        portraitDefocusColor: { value: 0x6ee9f2, type: "color", name: "Defocus Color" },
        portraitGlow: { value: 2.45, min: 0, max: 4, step: 0.05, name: "Glow" },
        portraitGlowRadius: { value: 3.3, min: 1, max: 6, step: 0.1, name: "Glow Radius" },
      },
      Signal: {
        portraitScanSpeed: { value: 0.43, min: 0, max: 2, step: 0.01, name: "Scan Speed" },
