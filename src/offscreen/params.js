...
export const params = {
  ...
  MeadowScene: {
    ...
    Roses: {
      ...
      roseScaleMin: { value: 0.5, min: 0.5, max: 8, step: 0.1, name: 'Minimum Scale' },
      roseScaleMax: { value: 5.2, min: 0.5, max: 10, step: 0.1, name: 'Maximum Scale' },
      roseScatter: { value: 0.8, min: 0, max: 4, step: 0.05, name: 'Trail Scatter' },
      roseLeanMax: { value: 24, min: 0, max: 55, step: 1, name: 'Maximum Lean' },
      roseVatFps: { value: 30, min: 1, max: 60, step: 1, name: 'VAT FPS' },
      roseVatEndFrame: { value: 120, min: 1, max: 168, step: 1, name: 'VAT Hold Frame' },
      roseGrowDuration: { value: 1.25, min: 0.1, max: 5, step: 0.05, name: 'Emergence Time' },
      roseLifetime: { value: 2.5, min: 1, max: 60, step: 0.5, name: 'Lifetime' },
      ...
      roseTint: { value: 0xffd9df, type: 'color', name: 'Tint' },
      roseRoughness: { value: 0.42, min: 0.05, max: 1, step: 0.01, name: 'Roughness' },
      roseLightStrength: { value: 1.25, min: 0, max: 4, step: 0.05, name: 'Screen Light' },
      roseLightSmoothing: { value: 0.72, min: 0, max: 1, step: 0.01, name: 'Light Normal Smoothing' },
      roseLightSoftness: { value: 0.9, min: 0.1, max: 1, step: 0.01, name: 'Light Softness' },
      roseScreenExclusionRadius: { value: 6, min: 0, max: 30, step: 0.25, name: 'Screen Exclusion' },
      roseWallExclusionRadius: { value: 3, min: 0, max: 30, step: 0.25, name: 'Wall Exclusion' },
      roseRippleRadius: { value: 2.8, min: 0.25, max: 8, step: 0.05, name: 'Ripple Radius' },
      ...
      roseRippleFoam: { value: 0.34, min: 0, max: 1, step: 0.01, name: 'Ripple Foam' },
      roseRippleDelay: { value: 0.55, min: 0, max: 1, step: 0.01, name: 'Ripple Timing' },
    },
    Camera: {
    ...
    Wall: {
      ...
      wallWidth: { value: 124, min: 30, max: 250, step: 1, name: "Width" },
      wallHeight: { value: 55, min: 20, max: 150, step: 1, name: "Height" },
