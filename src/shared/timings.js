...
export const easingDefinitions = [
  { name: 'linear' },
  { name: 'power1.in' }, { name: 'power1.out' }, { name: 'power1.inOut' },
  { name: 'power2.in' }, { name: 'power2.out' }, { name: 'power2.inOut' },
  { name: 'power3.in' }, { name: 'power3.out' }, { name: 'power3.inOut' },
  { name: 'power4.in' }, { name: 'power4.out' }, { name: 'power4.inOut' },
  { name: 'expo.in' }, { name: 'expo.out' }, { name: 'expo.inOut' },
  { name: 'sine.in' }, { name: 'sine.out' }, { name: 'sine.inOut' },
...
export function notifyTimingChange(group, key) {
  for (const listener of timingListeners) listener({ group, key, value: timings[group][key] });
}
